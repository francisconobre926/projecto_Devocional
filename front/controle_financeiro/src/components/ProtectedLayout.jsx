...
//   const [authed, setAuthed] = useState(() => readAuthFromStorage());

//   useEffect(() => {
//     const sync = () => setAuthed(readAuthFromStorage());

//     // atualiza quando login/logout acontecer no mesmo tab
//     window.addEventListener('auth:changed', sync);

//     // atualiza se mudar em outro tab
//     window.addEventListener('storage', sync);

//     // garante que, ao entrar numa rota nova, o estado bate com o storage
//     sync();
...
//   const from = useMemo(() => {
//     // guarda também querystring, se tiver
